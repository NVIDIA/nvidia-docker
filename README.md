...
# On Mac OS 11.X, due to Rootless mode, do this instead
# sudo tar --strip-components=1 -C /usr/local/bin -xvf /tmp/nvidia-docker*.tar.xz && rm /tmp/nvidia-docker*.tar.xz
